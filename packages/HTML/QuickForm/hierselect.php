        ...
        if ($this->_flagFrozen) {
            ...
            if (!defined('HTML_QUICKFORM_HIERSELECT_EXISTS')) {
                $this->_js .= "function swapOptions(frm, grpName, eleIndex, nbElements, arName)\n"
                             ...
                             ."        }\n"
                             ."    }\n\n"
                             ."    console.log('1'+arName + n);/* alert('this one   '+ n );*/var t = eval(\"typeof(\"+arName + n +\")\");\n"
                             ."    if (t != 'undefined') {\n"
                             ."        var the_array = eval(arName+n);\n"
                             ."        console.log('the_array');console.log(the_array);var j = 0;\n"
                             ."        var ending = n;//Use for search builder\n"
                             ."        n = eleIndex + 1;\n"
                             ."        ctl = frm[grpName+'['+ n +']'];\n"
                             ."        console.log('aqui' + grpName); console.log(frm); console.log('este otro '+grpName +n);console.log('este' +ctl);if (!ctl) {\n"
                             ."            ctl = frm[grpName+'['+ n +'][]'];\n"
                             ."        }\n"
                             ."        console.log('with text '+'mapper[1][0]'+ending+'_'+n+'_'+'      ' + arName+ending+'_'+n+'_'); console.log( frm[arName+ending+'_'+n+'_'] );\n"
                             ."        /*if (typeof(frm[arName+ending+'_'+n+'_']) != 'undefined' && frm[arName+ending+'_'+n+'_'] != null){  frm[arName+ending+'_'+n+'_'].style.display = 'inline'; } */ \n"
